      ...
      <div className="w-full max-w-sm rounded-2xl bg-white shadow-xl p-6">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div>
            ...
            <input
              className="w-full border rounded-xl p-2 outline-none focus:ring-2 focus:ring-green-500"
              value={username}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2 rounded-xl bg-green-600 text-white font-semibold hover:bg-green-700 disabled:opacity-60"
          >
